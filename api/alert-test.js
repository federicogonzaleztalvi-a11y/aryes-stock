// api/_alert-test.js — TEMPORAL. Dispara un log.error de prueba para verificar
...
export default async function handler(req, res) {
  ...
  log.error('_alert-test', 'Prueba de la Torre de Control — si ves este mail, las alertas funcionan', {
