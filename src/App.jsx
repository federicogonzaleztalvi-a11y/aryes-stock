    ...
    <div style={{minHeight:"100vh",background:"#f5f5f0",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Inter,sans-serif"}}>
      <div style={{background:"#fff",borderRadius:16,padding:"40px 36px",width:380,boxShadow:"0 8px 40px rgba(0,0,0,.10)"}}>
        ...
        <div style={{marginBottom:14}}>
          ...
          <input id="sb-email" type="email" placeholder="usuario@aryes.com" autoComplete="email"
            ...
            onKeyDown={e=>e.key==="Enter"&&document.getElementById("sb-pass").focus()} />
        </div>
        <div style={{marginBottom:22}}>
          ...
          <input id="sb-pass" type="password" placeholder="••••••••" autoComplete="current-password"
            style={{width:"100%",padding:"10px 12px",border:"2px solid #e5e7eb",borderRadius:8,fontSize:14,fontFamily:"inherit",boxSizing:"border-box"}}
            onKeyDown={e=>e.key==="Enter"&&handleLogin(document.getElementById("sb-email").value,document.getElementById("sb-pass").value)} />
        </div>
        <button onClick={()=>handleLogin(document.getElementById("sb-email").value,document.getElementById("sb-pass").value)}
...
function AryesApp(){
  ...
  const handleLogin=async(email,pw)=>{
    ...
    try{
      ...
      const u={id:d.user.id,email:d.user.email,role:m.role||"vendedor",username:m.username||email.split("@")[0],nombre:m.nombre||"Usuario",access_token:d.access_token,refresh_token:d.refresh_token};
