    ...
    <>
      {session && !dbReady && !demoMode && (
        <div style={{position:"fixed",inset:0,background:"#f9f9f7",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:16,zIndex:9999}}>
          <style>{CSS}</style>
          <img src="/pazque-logo.png" alt="Pazque" style={{height: 40,objectFit:"contain"}} onError={e=>e.target.style.display="none"} />
      ...
      <main id="main-content" style={{marginLeft:220,flex:1,height:"100vh",overflowY:"auto",display:"flex",flexDirection:"column"}}>
        ...
        {/* →→ TOPBAR →→ */}
        <div style={{display:"flex",alignItems:"center",gap:16,padding:"0 32px",height: 40,background:"#ffffff",borderBottom:"1px solid #f0ede8",position:"sticky",top:0,zIndex:100,flexShrink:0}}>
          {/* Search */}
