...
<head>
  ...
  <style>
    ...
    .header { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 40px; border-bottom: 3px solid #059669; padding-bottom: 24px; }
    .logo-area h1 { font-size: 28px; color: #059669; margin: 0 0 4px; font-weight: 700; }
...
<body>
  <div class="header">
    ...
    <div class="oc-info">
      ...
      <div class="num" style="color:#059669">${orderNum}</div>
    ...
    <table>
      ...
      <tbody>
        ...
        <tr class="total-row">
          ...
          <td style="text-align:right;padding:14px 12px;font-weight:700;color:#059669">$ ${total.toFixed(2)} ${sup.currency || 'USD'}</td>
        </tr>
      </tbody>
    </table>
  </div>
...
const MiniBar=({value,max,color='#059669'})=>{
        ...
        <div style={{display:'flex',flexDirection:'column',gap:10}}>
          {byValue.map((p,i)=>{
            ...
            return <div key={p.id}>
              ...
              <MiniBar value={val} max={maxVal} color={i<3?'#059669':'#b8d9a8'}/>
            </div>;
          })}
        </div>
      </div>
