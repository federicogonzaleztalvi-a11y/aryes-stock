  ...
  return(
    <div style={{padding:'32px 40px',maxWidth:900}}>
      ...
      {!selProduct&&!search?(
        ...
        <div>
          {selProduct&&<div style={{background:'#f0f7ec',border:'1px solid #b8d9a8',borderRadius:10,padding:'12px 16px',marginBottom:16,fontSize:13,color:'#059669',fontWeight:600}}>
