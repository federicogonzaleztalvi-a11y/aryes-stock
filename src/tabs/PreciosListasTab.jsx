...
function EditorPrecios({ lista, onBack, onListaUpdated, listas }) {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div style={{ background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 8, padding: '8px 14px', marginBottom: 14, fontSize: 12, color: '#92400e' }}>💡 <strong>Precio</strong> = precio exacto para esta lista (el gris es el base, como referencia). <strong>Dto. %</strong> = descuento sobre el precio base. El precio fijo tiene prioridad.</div>
      {copiarUuid && (() => {
      ...
      <div style={{ background: '#fff', borderRadius: 12, border: '1px solid #f0f0ec', overflow: 'hidden' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead><tr style={{ background: '#f9fafb', borderBottom: '2px solid #e5e7eb' }}>
            ...
            <th style={{ padding: '10px 12px', textAlign: 'center', fontSize: 11, fontWeight: 700, color: '#d97706', textTransform: 'uppercase', letterSpacing: .5, minWidth: 110 }}>Precio</th>
