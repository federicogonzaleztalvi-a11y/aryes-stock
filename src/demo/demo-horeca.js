...
export const demoHoreca = {
  ...
  products: [
    // Lácteos — Conaprole / Farming (packshots reales guardados en /img/demo/lacteos/)
    { id: 'h1', name: 'Queso Colonia Farming x 4kg', sku: 'LAC-001', category: 'Lácteos', supplier_id: 's1', unit: 'kg', price: 420, cost: 310, stock: 85, min_stock: 20, iva_rate: 22, imagen_url: '/img/demo/lacteos/colonia.jpg' },
    { id: 'h2', name: 'Queso Danbo Conaprole x 4kg', sku: 'LAC-002', category: 'Lácteos', supplier_id: 's1', unit: 'kg', price: 390, cost: 285, stock: 62, min_stock: 15, iva_rate: 22, imagen_url: '/img/demo/lacteos/danbo.png' },
    { id: 'h3', name: 'Mozzarella Conaprole x 5kg', sku: 'LAC-003', category: 'Lácteos', supplier_id: 's1', unit: 'kg', price: 350, cost: 260, stock: 120, min_stock: 30, iva_rate: 22, imagen_url: '/img/demo/lacteos/muzzarella.png' },
    { id: 'h4', name: 'Crema de leche Conaprole x 1L', sku: 'LAC-004', category: 'Lácteos', supplier_id: 's1', unit: 'un', price: 145, cost: 105, stock: 48, min_stock: 12, iva_rate: 22, imagen_url: '/img/demo/lacteos/crema.png' },
    { id: 'h5', name: 'Manteca Conaprole x 200g', sku: 'LAC-005', category: 'Lácteos', supplier_id: 's1', unit: 'un', price: 520, cost: 395, stock: 35, min_stock: 10, iva_rate: 22, imagen_url: '/img/demo/lacteos/manteca.png' },
    { id: 'h6', name: 'Dulce de leche Conaprole x 970g', sku: 'LAC-006', category: 'Lácteos', supplier_id: 's1', unit: 'un', price: 210, cost: 155, stock: 40, min_stock: 10, iva_rate: 22, imagen_url: '/img/demo/lacteos/dulce-de-leche.png' },
    { id: 'h7', name: 'Ricotta Conaprole x 500g', sku: 'LAC-007', category: 'Lácteos', supplier_id: 's1', unit: 'un', price: 175, cost: 128, stock: 28, min_stock: 8, iva_rate: 22, imagen_url: '/img/demo/lacteos/ricotta.png' },
    { id: 'h8', name: 'Yogur natural Conaprole x 200g', sku: 'LAC-008', category: 'Lácteos', supplier_id: 's1', unit: 'un', price: 290, cost: 210, stock: 18, min_stock: 6, iva_rate: 22, imagen_url: '/img/demo/lacteos/yogur.png' },
